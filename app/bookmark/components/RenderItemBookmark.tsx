...
export default function RenderItemBookmark({ data }: Props) {
  ...
  const handleChat = () => {
    if (userId == null) {
      alert("Vui lòng gọi vào số điện thoại");
    } else {
  ...
  return (
    <div
      className={`h-[130px] w-full min-w-[150px] flex border border-gray-300 rounded-md overflow-hidden shadow-sm mt-2 mb-2 
            ${
