    ...
    const promotions: Promotion[] = [
        {
            id: '1',
            title: 'Summer Sale',
            description: 'Get 20% off on all room bookings made before the end of August.',
    ...
    return (
        <div className="px-4 py-8 max-w-screen-xl mx-auto min-h-screen flex flex-col">
            ...
            <p className="text-lg mb-6">
                Khám phá các chương trình khuyến mãi và ưu đãi đặc biệt của chúng tôi để tiết kiệm nhiều hơn cho kỳ nghỉ
                của bạn. Đừng bỏ lỡ cơ hội để tận hưởng các ưu đãi hấp dẫn.
            </p>
            ...
            <div className="text-center mt-6">
                <Button type="primary" href="/contact">Nhận Thêm Thông Tin</Button>
            </div>
        </div>
    );
};
